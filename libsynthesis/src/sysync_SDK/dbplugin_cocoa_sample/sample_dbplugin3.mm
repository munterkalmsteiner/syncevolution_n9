...
#define DB_PLUGIN_NAMESPACE iPhone_dbplugin3
...
CocoaPluginModule *newPluginModule(
  ...
  return [[SamplePluginModule3 alloc]
...
@implementation SamplePluginModule3
...
@end // SamplePluginModule3



@implementation SamplePluginDB3
